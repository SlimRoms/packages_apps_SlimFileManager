...
public class ProcessManager extends ListActivity {
    ...
    protected void onListItemClick(ListView parent, View view, int position, long id) {
        ...
        CharSequence[] options = {view.getContext().getString(R.string.proc_details), view.getContext().getString(R.string.proc_launch)};
        final int index = position;

        builder.setTitle(view.getContext().getString(R.string.proc_options));
                ...
                switch (choice) {
                    ...
                    case 1:
                        ...
                        if(i != null)
                            ...
                            Toast.makeText(ProcessManager.this, R.string.process_error, Toast.LENGTH_SHORT).show();
    ...
    private void update_labels() {
        ...
        availMem_label.setText(String.format(getApplicationContext().getString(R.string.avail_mem) + ":\t %.2f Mb", mem_size));
        numProc_label.setText(getApplicationContext().getString(R.string.num_processes) + ":\t " + display_process.size());
    }
