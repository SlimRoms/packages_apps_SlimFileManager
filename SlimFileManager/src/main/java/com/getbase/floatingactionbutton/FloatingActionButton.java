...
public class FloatingActionButton extends ImageButton {
    ...
    private void updateCircleSize() {
        mCircleSize = getDimension(mSize == SIZE_NORMAL ?
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        ContextCompat.getDrawable(getContext(), mSize == SIZE_NORMAL ?
        ...
        shapeDrawable.setShaderFactory(new ShaderFactory() {
            ...
            public Shader resize(int width, int height) {
                return new LinearGradient(width / 2, 0, width / 2, height,
                        new int[]{topStrokeColor, topStrokeColorHalfTransparent,
    ...
    private static class TranslucentLayerDrawable extends LayerDrawable {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.saveLayerAlpha(bounds.left,
                    bounds.top, bounds.right, bounds.bottom, mAlpha, Canvas.ALL_SAVE_FLAG);
            super.draw(canvas);
            canvas.restore();
        }
    }
