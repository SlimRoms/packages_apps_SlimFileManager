...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray attr = context.obtainStyledAttributes(
                attributeSet, R.styleable.FloatingActionsMenu, 0, 0);
        ...
        mAddButtonStrokeVisible = attr.getBoolean(
                R.styleable.FloatingActionsMenu_fab_addButtonStrokeVisible, true);
        ...
        mLabelsPosition = attr.getInt(
                R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        attr.recycle();
    ...
    public void setAddButtonColorNormalResID(@ColorRes int color) {
        mAddButtonColorNormal = getColor(color);
        invalidate();
    }

    public void setAddButtonColorPressedResId(@ColorRes int color) {
        mAddButtonColorPressed = getColor(color);
        invalidate();
    }
    ...
    private void createAddButton(Context context) {
        mAddButton = new AddFloatingActionButton(context) {
            ...
            Drawable getIconDrawable() {
                mRotatingDrawable = new RotatingDrawable(super.getIconDrawable());

                final OvershootInterpolator interpolator = new OvershootInterpolator();

                final ObjectAnimator collapseAnimator =
                        ObjectAnimator.ofFloat(mRotatingDrawable, "rotation",
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                mAddButton.layout(addButtonLeft, addButtonY, addButtonLeft +
                        mAddButton.getMeasuredWidth(), addButtonY + mAddButton.getMeasuredHeight());
