 ...
 */
class IndicatorLinearLayout extends LinearLayout {
    ...
    public IndicatorLinearLayout(Context context, int attr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, attr, 0);
