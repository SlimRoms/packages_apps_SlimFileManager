...
public class SortUtils {
    ...
    public static void sort(ArrayList<BrowserFragment.Item> files) {
        String sortMode = SettingsProvider.getInstance(null)
                .getString(SettingsProvider.SORT_MODE, SORT_MODE_NAME);
        switch (sortMode) {
            case SORT_MODE_SIZE:
